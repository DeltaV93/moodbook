			...
			<div class="entry_view--icons row">
				...
				<div class="con-sm-6 pull-left">
					<ul class="list-unstyled">
						<li><a href="/home"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></a></span></li>
					</ul>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 entry_view--identifier__tags">
						<p class="light">#Boggarts #lavender #ganger #krum #invisibility #half-blood-Prince #Umbridge #dragon-scale #Sirius-Black #elf #grayback</p>
					</div>
				</div>
			</div>
