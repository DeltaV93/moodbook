	...
	<div class="entry_post_defult">
		...
		<div class=" row entry_post">
			...
			<div class="entry_post--identifier col-md-5 col-md-offset-1 col-xs-offset-3 col-xs-6">
				...
				<h3 class="entry_post--identifier__title light"><a href="{{ url('user/show').'/'.$entry->id }}">{{ $entry->entry_title }}</a></h3>
				<p class="entry_post--identifier__opener">{{$entry->entry_body }}<a href="user/show/{{ $entry->id}}">...</a></p>
