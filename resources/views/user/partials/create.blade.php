...
{{-- 		<div id='editor' class="col-sm-12">
			{!! Form::textarea('body_entry', null, ['class' => 'editable--textarea text-box col-md-12 opensans', 'id' =>'wysihtml-textarea', 'placeholder' => 'Enter your text here.','style'=>"width:100%"]) !!}
		</div> --}}
	</div>
